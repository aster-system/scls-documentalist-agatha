...
namespace scls {
    ...
    Text_Pattern::Text_Pattern(std::string name, std::string base_text): a_base_text(base_text), a_name(name) {

    }

    // Most basic Text_Piece constructor
    Text_Piece::Text_Piece(Text_Pattern& pattern): a_pattern(pattern) {
